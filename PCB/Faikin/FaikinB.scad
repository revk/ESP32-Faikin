...
difference(){bottom();translate([0.000000,0.000000,0])linear_extrude(0.250000)text("2025-07-23",size=2.000000,halign="center",valign="center",font="OCR-B");}